 ...
 *   everything else stays on the built-in on-device model. This is the
 *   mechanism only: the bench currently runs a single backend, so nothing here
 *   is wired into the live bench run yet.
 */
