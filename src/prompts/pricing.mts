...
export const PRICING_FEW_SHOT: Message[] = [
  {
    content:
      ...
      '<<<PRICING PAGE\n' +
      'Plans: claude-alpha-1 $3 / MTok input, $15 / MTok output. ' +
