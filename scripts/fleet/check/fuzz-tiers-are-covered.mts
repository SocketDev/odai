...
const SCRIPT_META: ScriptMeta = {
  describe:
    'verifies every language present in the repo carries its property-and-fuzz-testing tier',
  help: `Usage: node scripts/fleet/check/fuzz-tiers-are-covered.mts [flags]
